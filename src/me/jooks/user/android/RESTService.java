...
public class RESTService extends IntentService {
    ...
    public static final String EXTRA_HTTP_VERB       = "me.jooks.user.android.EXTRA_HTTP_VERB";
    public static final String EXTRA_PARAMS          = "me.jooks.user.android.EXTRA_PARAMS";
    public static final String EXTRA_RESULT_RECEIVER = "me.jooks.user.android.EXTRA_RESULT_RECEIVER";
    
    public static final String REST_RESULT = "me.jooks.user.android.REST_RESULT";
